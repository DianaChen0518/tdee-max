...
<template>
  <div
    class="fixed top-6 left-1/2 transform -translate-x-1/2 z-[100] flex flex-col gap-3 items-center pointer-events-none w-full max-w-sm px-4"
  >
    <transition-group
